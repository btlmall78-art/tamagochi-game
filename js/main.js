...
function updateTrickOverlayHUD() {
  ...
  if (trickComboText) {
    ...
    if (combo >= 10) {
      trickComboText.textContent = `🔥 x${combo} • MAX FLOW`;
    } else if (combo >= 6) {
      trickComboText.textContent = `🔥 x${combo} • HOT`;
    } else if (combo >= 3) {
      trickComboText.textContent = `🔥 x${combo} • FLOW`;
    } else {
      trickComboText.textContent = `🔥 x${combo}`;
    }
  }
